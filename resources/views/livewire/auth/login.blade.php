                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            ...
                            <img class="app-logo" src="/assets/img/brand/woodsland-logo.svg" width="100" height="65" alt="Logo" style="margin-bottom: 1rem;">
                            <h1 class="mb-3 h3">Đăng nhập</h1>
                            <p class="mb-0">Đăng nhập bằng thông tin sau:</p>
                            <p class="mb-0"> Email: <strong>phuoc.nguyen@vn.gt.com</strong> Password:
                        ...
                        <form wire:submit.prevent="login" action="#" class="mt-4" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div><a href="{{ route('forgot-password') }}" class="small text-right">Quên mật khẩu?</a></div>
                                </div>
                            </div>
                            <div class="d-grid">
